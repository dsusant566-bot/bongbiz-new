...
export default function AdminMaster() {
  // সেশন বা রিডাইরেক্ট লজিক পুরোপুরি সরিয়ে দেওয়া হয়েছে যাতে লোকাল হোস্টে সরাসরি খোলে।
    ...
    <div className="min-h-screen bg-[#f8fafc] p-4 md:p-10 font-sans text-slate-900">
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-12 text-center border-b pb-8">
          ...
          <div className="mt-2 inline-block bg-blue-100 text-blue-700 px-4 py-1 rounded-full text-[10px] font-bold uppercase">
            Local Access Mode (No Login Required)
          </div>
        </header>
